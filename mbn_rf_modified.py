...
class LandmarkHead(nn.Module):
	def __init__(self,inchannels=512,num_anchors=3):
		...
		self.conv1x1 = nn.Conv2d(inchannels,num_anchors*40,kernel_size=(1,1),stride=1,padding=0)
...
def conv_dw(inp, oup, stride):
	return nn.Sequential(
		nn.Conv2d(in_channels=inp, out_channels=inp, kernel_size=3, stride=stride, padding=1, bias=False),
		nn.BatchNorm2d(inp),
		nn.LeakyReLU(0.1),
